...
workflow FASTP_FASTQC {
    ...
    ch_sample_multiqc_inputs = ch_sample_multiqc_inputs.mix(FASTQC.out.tool_params)
    ch_sample_multiqc_inputs = ch_sample_multiqc_inputs.mix(FASTP.out.tool_params)
    ch_multiqc_files = ch_multiqc_files.mix(ch_multiqc_inputs.collect{it[1]})
    ch_multiqc_files = ch_multiqc_files.mix(FASTQC.out.tool_params.collect { it[1] })
